...
### Cookies
We use cookies only for basic site functionality and analytics. We do not use advertising cookies or tracking pixels.
...
- **Mailchimp** (Intuit Inc.) processes and stores subscriber data for email delivery. [Mailchimp Privacy Policy](https://www.mailchimp.com/legal/privacy/)
- **Google Analytics** (Google LLC) processes anonymous site usage data. [Google Privacy Policy](https://policies.google.com/privacy)
- **GitHub Pages** hosts this website.
- We may integrate additional services in the future and will update this policy accordingly.
...
We retain your email address and any information you provide for as long as you remain subscribed. When you unsubscribe, your data is removed from our active mailing list. Mailchimp may retain anonymized data for their own analytics.
...
For any privacy questions or data requests: **hello@datadrip.co**
